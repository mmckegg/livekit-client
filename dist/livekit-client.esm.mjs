...
class PCTransport {
  constructor(config, forceStereoAudioSupport) {
    this.pendingCandidates = [];
    this.restartingIce = false;
    this.renegotiate = false;
    this.trackBitrates = [];
    this.forceStereoAudioSupport = false; // debounced negotiate interface
    ...
    this.forceStereoAudioSupport = forceStereoAudioSupport !== null && forceStereoAudioSupport !== void 0 ? forceStereoAudioSupport : false;
  }
...
function ensureStereoAudio(media) {
